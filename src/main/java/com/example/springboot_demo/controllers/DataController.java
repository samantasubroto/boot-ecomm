...
public class DataController {
    ...
    public String setUser() {
        ...
        users.add(new User("vikas","sharma","vikassharma@gmail.com","Sharma@","9348291212"));
        users.add(new User("shreyas","sharma","shreyassharma@gmail.com","Sharma@","9348291213"));
        users.add(new User("virat","sharma","viratsharma@gmail.com","Sharma@","9348291214"));
        users.add(new User("raina","sharma","rainasharma@gmail.com","Sharma@","9348291215"));
